...
def convert_ply_2_mpu(mesh_dir, mpu_dir):
...
def sample_mesh(mpu_dir, npts_dir, sample_cnt):
...
if __name__ == '__main__':
    ...
    convert_ply_2_mpu(argument_vals.ply_dir, argument_vals.mpu_dir)
    sample_mesh(argument_vals.mpu_dir, argument_vals.npts_dir, argument_vals.pts_num)
    npts_to_ply_in_batch(argument_vals.npts_dir, argument_vals.ply_pc_dir)
    #fn_main(sys.argv)
